...
export class DashboardPage {
  ...
  public async requestWalkInBathForm(
    testData: WalkInBathTestData,
  ): Promise<void> {
  ...
  public async estimateForm(username: string, email: string): Promise<void> {
    this.logger.info(
      `Updating estimateForm form with ${username} and ${email}`,
    );
  ...
  public async futureInstallationEmailRequestForm(
    email: string,
  ): Promise<void> {
    this.logger.info(
      `Updating futureInstallationEmailRequestForm form with ${email}`,
    );
